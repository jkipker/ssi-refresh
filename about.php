		...
		<div class="container inner-page-template">
			...
			<div class="home-sub-section">
				<div class="content-section services-section">								
					<h1>About Us</h1>
					<p class="mission">“Deliver leading edge engineering and business solutions and effectively meet the needs of our clients and employees.”</p>
			...
			<div class="home-sub-section home-sub-gray">
				<div class="content-section services-section">
					...
					<h2>What Synergy Means to Us</h2>
				...
				<div class="content-section services-section">								
					...
					<div class="services-row">
						<div class="services-block">
							<img class="portrait" src="img/portrait-fpo.jpg"/>
							<span class="name">Craig Thomas</span>
							<span class="title">Title</span>
							<div class="email"><a href="#">email@southernsynergy.com</a></div>
						</div>

						<div class="services-block">
							<img class="portrait" src="img/portrait-fpo.jpg"/>
							<span class="name">Jim Harbin</span>
							<span class="title">Title</span>
							<div class="email"><a href="#">email@southernsynergy.com</a></div>
						</div>
						...
						<div class="services-block">
							<img class="portrait" src="img/portrait-fpo.jpg"/>
							<span class="name">Kay Harbin</span>
							<span class="title">Title</span>
							<div class="email"><a href="#">email@southernsynergy.com</a></div>
						</div>
					</div>
					<div class="services-row">
						<div class="services-block">
							<img class="portrait" src="img/portrait-fpo.jpg"/>
							<span class="name">Randall Kipker</span>
							<span class="title">Title</span>
							<div class="email"><a href="#">email@southernsynergy.com</a></div>
						</div>
						...
						<div class="services-block">
							<img class="portrait" src="img/portrait-fpo.jpg"/>
							<span class="name">Chris Black</span>
							<span class="title">Title</span>
							<div class="email"><a href="#">email@southernsynergy.com</a></div>
						</div>
